...
const AddPage = () => {
  ...
  const handleAddPage = async (e) => {
    ...
    const pageAPi = "https://secom.privateyebd.com/api/v1/utility/admin/page/";

    await axios
      .post(pageAPi, pageForm, {
        headers: {
          Authorization: accessToken,
        },
      })
  ...
  return (
    <section className="add-page-area">
      <div className="project-container">
        <h2 className="my-4 fs-4">Add New Page</h2>
